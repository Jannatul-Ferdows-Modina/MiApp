...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "sepataraReportService"];
    ...
    var controller = function ($scope, $filter, $timeout, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        //#region General
        debugger;
        $scope.pageTitle = "Sepatara Commission";
        $scope.breadcrumbs = ["Report", "Sepatara Commission"];
        $scope.page = appUrl.sepataraCommission;
        $scope.tabs = appUrl.sepataraCommission.tabs;
        ...
        $scope.performQuickBookAddComm = function (source, target,obj) {

            var docid = source.currentTarget.attributes["docid"].value;
            var modalInstance = $uibModal.open({
                animation: false,
                backdrop: "static",
                keyboard: false,
                size: "lg",
                templateUrl: "app/components/report/sepataraCommission/addcommission.html",
                controller: "addSepCommModelController",
                resolve: {
                    requestData: function () {
                        ...
                        return {
                            ...
                            sepatrapartnername: obj.sepataraPartnerName
                        };
                    }
                }
            });
    ...
    app.register.controller("sepataraCommissionController", controller);
