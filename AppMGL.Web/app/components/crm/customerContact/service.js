...
define(["app"], function (app) {
    ...
    var service = function ($http, $q, ngAuthSettings, Upload) {
        ...
        this.getCompanySearchCRM = function (listfilter) {
            return $http({
                headers: { 'Content-Type': "application/json" },
                url: serviceBase + "CompanySearchCRM/",
                method: "POST",
                data: listfilter
        ...
        this.listcrm = function (listParams) {
            return $http({
                headers: { 'Content-Type': "application/json" },
        ...
        this.checkisapprovedauthorization = function (odjata) {
            return $http({
                headers: { 'Content-Type': "application/json" },
                url: serviceBase + "checkisapprovedauthorization/",
                method: "POST",
                data: odjata

            });
        };
        this.exportContactReport_CRM = function (reportParams) {
            return $http({
                cache: false,
                headers: { 'Content-Type': "application/json" },
                url: serviceBase + "exportContactReport_CRM/",
                method: "POST",
                data: reportParams,
                responseType: "arraybuffer"
            });
        ...
        this.uploadImportFile = function ($file, id) {
            return Upload.upload({
                url: serviceBase + "ImportCustomer_CRM/" + id,
                method: "POST",
                responseType: "arraybuffer",
                file: $file
            });
        ...
        this.createenquierycrm = function (obj) {
            return $http({
                headers: { 'Content-Type': "application/json" },
                url: serviceBase + "CreateEnquieryCRM/",
                method: "POST",
                data: obj
    ...
    app.register.service("crmcustomerContactService", service);
