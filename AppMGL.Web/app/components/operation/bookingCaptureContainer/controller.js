...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$location", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "bookingCaptureContainerService"];
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        //#region General
        $scope.page = appUrl.bookingCaptureContainer;
        $scope.tabs = appUrl.bookingCaptureContainer.tabs;

        $scope.$parent.pageTitle = "Capture Container & Seal No";
        $scope.$parent.breadcrumbs = ["Shipment", "Trucking", "Capture Container & Seal No"];
        ...
        $scope.bookinglistTable = new NgTableParams(
              {
                  ...
                  getData: function (params) {
                      ...
                      var dataitems = entityService.getDispatchContainerList(listParams).then(
                          function (output) {
    ...
    app.register.controller("bookingCaptureContainerController", controller);
