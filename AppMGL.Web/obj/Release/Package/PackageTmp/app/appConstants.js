define(['require'], function (r) {
    ...
    var constants = {
        mainMenus: {
            shipment: {
                'quotation': [{ menu: 'Create Quotation', url: '/operation/quotation', header: 'CQ' },
                    { menu: 'Pending Shipper Approval', url: '/operation/quotationApproval', header: 'PSA' },
                    { menu: 'Sent for Booking', url: '/operation/quotationBooking', header: 'SB' }],
                'booking': [{ menu: 'Booking To Do', url: '/operation/booking', header: 'BT' },
                    ...
                    { menu: 'Rollover Records', url: '/operation/bookingRoleOver', header: 'RR' }],
            ...
            report: [{ menu: 'Enquiry', url: '/report/enquiryReport', header: 'E', menuID: 5 },
                    { menu: 'Quotation', url: '/report/quotationReport', header: 'Q', menuID: 5 },
                    { menu: 'Export Register Report', url: '/report/exportRegisterReport', header: 'ER', menuID: 5 },
                    { menu: 'Expense Report', url: '/report/expensesReport', header: 'ER', menuID: 5 },
                    { menu: 'Process Invoice Report', url: '/report/processInvoiceReport', header: 'PI', menuID: 5 },
                    { menu: 'Activity Due Report', url: '/report/activityDueReport', header: 'AD', menuID: 5 },
                    { menu: 'SP MCS', url: '/report/mcsReport', header: 'SP', menuID: 5 },
                    { menu: 'Booking', url: '/report/bookingReport', header: 'B', menuID: 5 },
                    { menu: 'Miami Bookingng Status', url: '/report/bookingStatusReport', header: 'MB', menuID: 5 },
                    { menu: 'Region Wise Container Report', url: '/report/regionWiseContainerReport', header: 'RW', menuID: 5 }
            ],
            ...
            'system entities': [{ menu: 'Country', url: '/setup/country', header: 'C', menuID: 7 },
                    { menu: 'State', url: '/setup/states', header: 'S', menuID: 7 },
