...
define(["app"], function (app) {
    ...
    var service = function ($http, $q, ngAuthSettings, Upload) {
        ...
        this.QuckbookVendorcreates = function (id, userid) {
            //alert('Come ' + serviceBase + "getQuickBookContactDetail/" + id + "Userid" + userid);
            return $http({
                headers: { 'Content-Type': "application/json", 'Pragma': "no-cache", 'Cache-Control': "no-cache", 'Userid': userid },
                url: serviceBase + "QuckbookVendorcreates/" + id,
                method: "GET"
    ...
    app.register.service("vendorCustomerContactService", service);
