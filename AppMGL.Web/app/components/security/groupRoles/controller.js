...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$timeout", "$uibModal", "$uibModalInstance", "localStorageService", "NgTableParams", "ngNotifier", "authService", "groupRolesService", "requestData"];
    ...
    var controller = function ($scope, $timeout, $uibModal, $uibModalInstance, localStorageService, NgTableParams, ngNotifier, authService, entityService, requestData) {
        ...
        var save = function () {
            ...
            items.forEach(function (item) {
                if (item.selected) {
                    item.groupId = requestData.groupId;
        ...
        $scope.otherId = requestData.groupId;
    ...
    app.register.controller("groupRolesController", controller);
