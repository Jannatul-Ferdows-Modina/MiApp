...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "lgvwexportinformationService"];
    ...
    var controller = function ($scope, $filter, $timeout, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.page = appUrl.lgvwexportinformation;
        $scope.tabs = appUrl.lgvwexportinformation.tabs;
    ...
    app.register.controller("lgvwexportinformationController", controller);
