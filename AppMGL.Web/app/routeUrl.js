var appUrl = (function () {
    ...
    var basePath = {
        ...
        ees: "app/components/ees/",
        crm: "app/components/crm/",
        sell: "app/components/seller/"
    ...
    factory.login = {
        ...
        depend: [
           // basePath.controllers + "app/controllers/loginController.jsloginController.js",
    ...
    factory.user = {
        ...
        criteria: [
            ...
            //Utility.createFilter("cntTypeF", "string", "LG_CONTACT.LG_DEPARTMENT.cntTypeF")
        ],
        logCriteria: null,
    ...
    factory.userjobrole = {
        ...
        urls: getPageUrls("sec", "userjobrole", null),

        tabs: [
            { title: "Detail", url: basePath.sec + "userjobrole/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string", "Name"),
           
        ],
        logCriteria: null,
        depend: getDependencies("sec", "userjobrole", [
            basePath.sec + "userjobrole/controller.js",
            basePath.sec + "userjobrole/service.js"])
        
    };
    factory.exporttarget = {

        modId: "527",
        title: "Export Traget",
        keyField: "Id",
        sortField: "TargetYear",
        sortType: "asc",

        urls: getPageUrls("sec", "exporttarget", null),

        tabs: [
            { title: "Detail", url: basePath.sec + "exporttarget/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string", "Name"),
        ...
        logCriteria: null,
        depend: getDependencies("sec", "exporttarget", [
            basePath.sec + "exporttarget/controller.js",
            basePath.sec + "exporttarget/service.js"])
    ...
    factory.customerContact = {
        ...
        depend: getDependencies("opr", "customerContact", [
            ...
            basePath.opr + "customerContact/qbcustpopupModelController.js",
	    basePath.opr + "customerContact/sendmailModelController.js",
            basePath.opr + "customerContact/addcustaddresspopupModelController.js"
    ...
    factory.corporatedashboard = {
        ...
        urls: getPageUrls("home", "corporate/dashboard", null),

        tabs: [
            { title: "Detail", url: basePath.home + "corporate/dashboard/detail.html" }
        ],

        logCriteria: null,

        depend: getDependencies("home", "corporate/dashboard", [])
    };
    ...
    factory.ratecapturequotation = {

        modId: "506",
        title: "Rate Capture Quotation",
        keyField: "CCID",
        sortField: "CCID",
        sortType: "DESC",

        urls: getPageUrls("opr", "rateCaptureQuotation", null),

        tabs: [
            { title: "Rate Capture", url: basePath.opr + "rateCaptureQuotation/detail.html" }
        ...
        depend: getDependencies("opr", "rateCaptureQuotation", [])
    ...
    factory.quotation = {
        ...
        depend: getDependencies("opr", "quotation", [
            ...
            basePath.opr + "quotation/quotationtraModelController.js"
    ...
    factory.sitechange = {
        ...
        urls: getPageUrls("opr", "sitechange", null),

        tabs: [
            { title: "Site Change ", url: basePath.opr + "sitechange/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("opr", "sitechange", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
    ...
    factory.containerstuffing = {
        ...
        urls: getPageUrls("opr", "containerstuffing", null),

        tabs: [
            { title: "Booking", url: basePath.opr + "containerstuffing/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("opr", "containerstuffing", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
    ...
    factory.containermanagement = {
        ...
        urls: getPageUrls("opr", "containermanagement", null),

        tabs: [
            { title: "Booking", url: basePath.opr + "containermanagement/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("opr", "containermanagement", [])
    };
    factory.containerbooking = {
        ...
        urls: getPageUrls("opr", "containerbooking", null),

        tabs: [
            { title: "Booking", url: basePath.opr + "containerbooking/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("opr", "containerbooking", [])
    };
    factory.consolidatedockReceipt = {
        ...
        urls: getPageUrls("opr", "consolidatedockReceipt", null),

        tabs: [
            
            { title: "Detail", url: basePath.opr + "consolidatedockReceipt/detail.html" }
        ],
        ...
        depend: getDependencies("opr", "consolidatedockReceipt", [
            basePath.dmt + "siplCompanyModal/controller.js",
            basePath.dmt + "siplCompanyModal/service.js",
            basePath.dmt + "siplPortModal/controller.js",
            basePath.dmt + "siplPortModal/service.js",
    ...
    factory.bookingCaptureContainerAbandonement = {

        modId: "217",
        title: "Capture Container Abandonement ",
        keyField: "EnquiryNo",
        sortField: "FileNo",
        sortType: "DESC",

        urls: getPageUrls("opr", "bookingCaptureContainerAbandonement", null),

        tabs: [
            { title: "Capture Container", url: basePath.opr + "bookingCaptureContainerAbandonement/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("opr", "bookingCaptureContainerAbandonement", [])
    };
    ...
    factory.documentation1 = {
        ...
        urls: getPageUrls("opr", "documentation1", null),

        tabs: [
            { title: "documentation1", url: basePath.opr + "documentation1/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("opr", "documentation1", [])
    };
    ...
    factory.freightforwardernetwork = {

        modId: "522",
        title: "Freight Forwarder Network",
        keyField: "FFNetworkID",
        sortField: "FFNetworkName",
        sortType: "asc",

        urls: getPageUrls("dmt", "freightforwardernetwork", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "freightforwardernetwork/detail.html" }
        ],
        criteria: [
            Utility.createFilter("CompanyName", "string"),
            Utility.createFilter("CustomerCode", "string"),
        ...
        depend: getDependencies("dmt", "freightforwardernetwork", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
    ...
    factory.freightforwardermapping = {

        modId: "523",
        title: "Freight Forwarder Mapping",
        keyField: "ContactID",
        sortField: "CompanyName",
        sortType: "asc",

        urls: getPageUrls("dmt", "freightforwardermapping", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "freightforwardermapping/detail.html" }
        ],
        criteria: [
            Utility.createFilter("CompanyName", "string"),
            Utility.createFilter("CustomerCode", "string"),
        ...
        depend: getDependencies("dmt", "freightforwardermapping", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
    ...
    factory.ddtcitar = {
        ...
        title: "DDTC ITAR",
        keyField: "ID",
        sortField: "DDTCITARCODE",
        sortType: "asc",

        urls: getPageUrls("dmt", "ddtcitar", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "ddtcitar/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string"),
            Utility.createFilter("Alias", "string")
        ...
        depend: getDependencies("dmt", "ddtcitar", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
    ...
    factory.ddtcusml = {
        ...
        title: "DDTC USML",
        keyField: "ID",
        sortField: "DDTCUSMLCODE",
        sortType: "asc",

        urls: getPageUrls("dmt", "ddtcusml", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "ddtcusml/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string"),
            Utility.createFilter("Alias", "string")
        ...
        depend: getDependencies("dmt", "ddtcusml", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
    ...
    factory.lgvwhtscode = {
        ...
        urls: getPageUrls("dmt", "lgvwhtscode", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "lgvwhtscode/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string")
            /*Utility.createFilter("StateName", "string")*/
        ...
        depend: getDependencies("dmt", "lgvwhtscode", [
            basePath.dmt + "lgvwhtscode/controller.js",
            basePath.dmt + "lgvwhtscode/service.js" ])
    };
    factory.lgvwlienseexemption = {

        modId: "519",
        title: "LGVWlienseexemption",
        keyField: "ID",
        sortField: "Name",
        sortType: "asc",


        urls: getPageUrls("dmt", "lgvwlienseexemption", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "lgvwlienseexemption/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string")
            /*Utility.createFilter("StateName", "string")*/
        ...
        depend: getDependencies("dmt", "lgvwlienseexemption", [
            basePath.dmt + "lgvwlienseexemption/controller.js",
            basePath.dmt + "lgvwlienseexemption/service.js"])
    };
    factory.lgvwmodeoftransport = {

        modId: "520",
        title: "lgvwmodeoftransport",
        keyField: "TransportModeID",
        sortField: "Name",
        sortType: "asc",


        urls: getPageUrls("dmt", "lgvwmodeoftransport", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "lgvwmodeoftransport/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string"),
            Utility.createFilter("StateName", "string")
        ...
        logCriteria: null,
        depend: getDependencies("dmt", "lgvwmodeoftransport", [
            basePath.dmt + "lgvwmodeoftransport/controller.js",
            basePath.dmt + "lgvwmodeoftransport/service.js"])
    };
    factory.lgvwexportinformation = {

        modId: "521",
        title: "lgvwexportinformation",
        keyField: "TransportModeID",
        sortField: "Name",
        sortType: "asc",


        urls: getPageUrls("dmt", "lgvwexportinformation", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "lgvwexportinformation/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string"),
            Utility.createFilter("StateName", "string")
        ...
        logCriteria: null,
        depend: getDependencies("dmt", "lgvwexportinformation", [
            basePath.dmt + "lgvwexportinformation/controller.js",
            basePath.dmt + "lgvwexportinformation/service.js"])
    };
    //#endregion
    ...
    factory.mcsReport = {
        ...
        depend: getDependencies("rpt", "mcsReport", [
            ...
            basePath.dmt + "siplCityModal/controller.js",
            basePath.dmt + "siplCityModal/service.js",
            basePath.rpt + "quickbooksync/controller.js",
            basePath.rpt + "quickbooksync/service.js",
            basePath.opr + "customerContact/qbcustpopupModelController.js",
            basePath.opr + "customerContact/service.js",
        ])
    };
    ...
    factory.dockReceipt = {
        ...
        tabs: [
           ...
           { title: "Detail", url: basePath.doc + "dockReceipt/detail.html" }
        ],
        ...
        depend: getDependencies("doc", "dockReceipt", [
            ...
            basePath.doc + "viewDocumentList/controller.js",
            basePath.doc + "viewDocumentList/service.js",
            basePath.doc + "viewDockTemplate/controller.js",
            basePath.doc + "viewDockTemplate/service.js"
        ])
    };
    factory.dockReceiptDirect = {
        ...
        urls: getPageUrls("doc", "dockReceiptDirect", null),

        tabs: [
            { title: "Detail", url: basePath.doc + "dockReceiptDirect/detail.html" }
        ],
        ...
        depend: getDependencies("doc", "dockReceiptDirect", [
            basePath.dmt + "siplCompanyModal/controller.js",
            basePath.dmt + "siplCompanyModal/service.js",
            basePath.dmt + "siplPortModal/controller.js",
            basePath.dmt + "siplPortModal/service.js",
    ...
    factory.hbl = {
        ...
        tabs: [
            { title: "Detail", url: basePath.doc + "hbl/detail.html" }
        ],
        criteria: [
            Utility.createFilter("MiamiRefNo", "string"),
            Utility.createFilter("SystemRefNo", "string"),
        ...
        depend: getDependencies("doc", "hbl", [
            ...
            basePath.dmt + "siplPortModal/controller.js",
            basePath.dmt + "siplPortModal/service.js",
            basePath.doc + "viewHBLTemplate/controller.js",
            basePath.doc + "viewHBLTemplate/service.js"
        ])
    };
    ...
    factory.qb = {
        modId: "505",
        title: "QB",
        urls: { index: basePath.views + "index.html" }
    };
    //#endregion
    ...
    factory.eessub = {
        ...
        modId: "292",
        title: "AES Submission",
        keyField: "SystemRefNo",
        sortField: "LastRemarkDate",
        sortType: "ASC",

        urls: getPageUrls("ees", "eesSub", null),

        tabs: [
            { title: "EES Submission", url: basePath.ees + "eessub/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("ees", "eessub", [
            basePath.rpt + "documentUploadModel/controller.js",
            basePath.rpt + "documentUploadModel/service.js",
            basePath.dmt + "siplCompanyModal/controller.js",
            basePath.dmt + "siplCompanyModal/service.js",
            basePath.dmt + "htsCodeModal/controller.js",
            basePath.dmt + "htsCodeModal/service.js",
            basePath.ees + "eessub/fileshistoryModelController.js",
            basePath.ees + "eessub/templatedataController.js",
            basePath.dmt + "siplPortModal/controller.js",
            basePath.dmt + "siplPortModal/service.js",
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
    ...
    //#endregion
    factory.crmcustomerContact = {

        modId: "528",
        title: "CRMCustomerContact",
        keyField: "ContactID",
        sortField: "CompanyName",
        sortType: "asc",

        urls: getPageUrls("crm", "customerContact", null),

        tabs: [
            { title: "Detail", url: basePath.crm + "customerContact/detail.html" }
        ],
        criteria: [
            Utility.createFilter("CompanyName", "string"),
            Utility.createFilter("CustomerCode", "string"),
        ...
        depend: getDependencies("crm", "customerContact", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
            ...
            basePath.dmt + "continentModal/controller.js",
            basePath.dmt + "continentModal/service.js",
            basePath.crm + "customerContact/qbcustpopupModelController.js",
	        basePath.crm + "customerContact/sendmailModelController.js",
            basePath.crm + "customerContact/addcustaddresspopupModelController.js",
            basePath.crm + "customerContact/xlsx.core.min.js"
    ...
    factory.crmenquiry = {
        ...
        urls: getPageUrls("crm", "enquiry", null),

        tabs: [
            { title: "Detail", url: basePath.crm + "enquiry/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("crm", "enquiry", [
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            basePath.dmt + "siplStateModal/controller.js",
            basePath.dmt + "siplStateModal/service.js",
            ...
            basePath.dmt + "siplTerminalModal/controller.js",
            basePath.dmt + "siplTerminalModal/service.js",
            basePath.crm + "enquiry/nextdateModelController.js",
            basePath.crm + "enquiry/viewbookingController.js",
            basePath.crm + "enquiry/bookingdetailController.js",
            basePath.crm + "enquiry/addRemarkController.js"
        ])
    };

    factory.sepataraCommission = {

        modId: "531",
        title: "Sepatra Commission",
        keyField: "ExportRef",
        sortField: "ExportRef",
        sortType: "asc",

        urls: getPageUrls("rpt", "sepataraCommission", null),

        tabs: [
            { title: "Detail", url: basePath.rpt + "sepataraCommission/index.html" }
        ],
        criteria: [
            Utility.createFilter("SiteId", "string"),
            Utility.createFilter("StartBookingDate", "string"),
        ...
        depend: getDependencies("rpt", "sepataraCommission", [
            basePath.dmt + "siplCompanyModal/controller.js",
            basePath.dmt + "siplCompanyModal/service.js",
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
            ...
            basePath.opr + "customerContact/qbcustpopupModelController.js",
            basePath.opr + "customerContact/service.js",
            basePath.rpt + "sepataraCommission/addSepCommModelController.js"
        ])
    };
    factory.warehouselocation = {
        ...
        urls: getPageUrls("dmt", "warehouselocation", null),

        tabs: [
            { title: "Detail", url: basePath.dmt + "warehouselocation/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string")
        ],
        ...
        depend: getDependencies("dmt", "warehouselocation", [])
    };
    factory.warehousemapping = {
        ...
        urls: getPageUrls("opr", "warehousemapping", null),

        tabs: [
            { title: "Detail", url: basePath.opr + "warehousemapping/detail.html" }
        ],
        criteria: [
            Utility.createFilter("Name", "string")
        ],
        ...
        depend: getDependencies("opr", "warehousemapping", [basePath.opr + "warehouseMapping/searchQuotationController.js"])
    };
    factory.mcsReportCorporate = {
        ...
        urls: getPageUrls("home", "corporate/mcsReport", null),

        tabs: [
            { title: "Detail", url: basePath.rpt + "corporate/mcsReport/index.html" }
        ],
        criteria: [
            Utility.createFilter("SiteId", "string"),
            Utility.createFilter("StartBookingDate", "string"),
        ...
        depend: getDependencies("home", "corporate/mcsReport", [
            basePath.dmt + "siplCompanyModal/controller.js",
            basePath.dmt + "siplCompanyModal/service.js",
            basePath.dmt + "siplcountryModal/controller.js",
            basePath.dmt + "siplcountryModal/service.js",
    ...
    factory.exportRegisterReportCorporate = {
        ...
        urls: getPageUrls("home", "corporate/exportRegisterReport", null),

        tabs: [
            { title: "Export Register Report", url: basePath.home + "corpoate/exportRegisterReport/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("home", "corporate/exportRegisterReport", [
                            basePath.rpt + "documentUploadModel/controller.js",
                            basePath.rpt + "documentUploadModel/service.js"
        ])
    };
    ...
    //    urls: getPageUrls("sell", "sliform", null),

    //    tabs: [
    //        { title: "sliform", url: basePath.sell + "sliform/detail.html" }
    //    ],
    //    criteria: [
    //        Utility.createFilter("searchOptionValue", "string"),
    //        Utility.createFilter("searchBox", "string")
    ...
    //    depend: getDependencies("sell", "sliform", [])
    //};
 ...
 factory.aestemplate = {
        ...
        sortField: "FileNo",
        sortType: "DESC",
        urls: getPageUrls("ees", "aestemplate", null),

        tabs: [
            { title: "AES Template", url: basePath.ees + "aestemplate/detail.html" }
        ],
        criteria: [
            Utility.createFilter("searchOptionValue", "string"),
            Utility.createFilter("searchBox", "string")
        ...
        depend: getDependencies("ees", "aestemplate", [])
    };
