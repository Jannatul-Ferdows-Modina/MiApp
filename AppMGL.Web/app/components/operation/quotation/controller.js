...
define(["app"], function (app) {
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.initDropdown = function () {
            ...
            setTimeout(function () { $("#chkisdraft").prop('checked', false) }, 500);
        };
        ...
        $scope.getDefaultEmailRemarks = function () {
            ...
            emailTerms += "<ul style='color: blue; font-size:12px;font-weight:normal; font-family:Arial,Helvetica,sans-serif;'>";
            emailTerms += "<li style='padding-bottom:10px;'>One hour free  load and thereafter USD 100/hr. Drop n pick will be double unless otherwise advised .</li>";
            ...
            emailTerms += "<li style='padding-bottom:10px;'>Chassis rental fee for one day included. All charges thereafter will be charged @ $40 to 80 / DAY depending on location.</li>";
            ...
            emailTerms += "<li style='padding-bottom:10px;'>Pre-Pull charges will be applicable for pulling out container on the previous day if loading is schedule for early morning appointment .</li>";
            emailTerms += "<li style='padding-bottom:10px;'>If TWO stop loading is required, you will get only ½ Hour free at each stop means total 1 hrs. for both the stops .</li>";
            emailTerms += "<li style='padding-bottom:10px;'>Foodstuffs, Liquor, Additives, Tobacco, Animal Skin, Veterinary &amp; Agricultural products  require approval from HUB and/or Destination Office.</li>";
            emailTerms += "<li style='padding-bottom:10px;'>HS Codes &amp; other docs. may be required for approval &amp; loading.</li>";
             emailTerms += "<li style='padding-bottom:10px;'>Cargo must be palletized.</li>";
              emailTerms += "<li style='padding-bottom:10px;'>Due to ongoing uncertainties in booking and non-availability of containers and storage space at terminals , many a times after issuing empty containers lines are shifting their ERD and dates of receiving containers in the yard . Such situations force us to store containers in private warehouses and involve additional move of containers at an extra cost . While we try our best to avoid such situation ,  under unavoidable situations any extra charges incurred in storage , security and additional trips made by truckers will be payable by you</li>";
              emailTerms += "<li style='padding-bottom:10px;'>Above rates subject to the following :<ul><li>TRUCKER AVAILABILITY</li><li>CONTAINER AVAILABILITY</li><li>CHASSIS AVAILABILITY</li><li>Booking availability</li></ul></li>";
            emailTerms += "<li style='padding-bottom:10px;'>Above rates subject to additional charges due to change in EARLIEST RECEIVING which may change on daily basis.</li>";
            emailTerms += "<li style='padding-bottom:10px;'>Due to current market scenario NO GUARANTEE of Loading on Particular date</li>";
            emailTerms += "<li style='padding-bottom:10px;'>Subject to weight approval from shipping line</li>";
            emailTerms += "<li style='padding-bottom:10px;'><span style='background-color:red;'>LAP TOP BATTERIES</span> <ul><li>Many Lines consider Laptop Batteries as DG and require a specific declaration even if batteries are fitted in laptops as part of the equipment . Non observance of this may lead to payment of penalties which will be shipper’s responsibility ,kindly note.</li> </ul></li>";
            emailTerms += "</ul>";
            ...
            emailTerms += "<h4><span style='font-size: 18px;font-weight: bold;'>THE SHIPPER'S BOOKING OF CARGO AFTER RECEIVING THE TERMS OF THIS NRA OR NRA AMENDMENT CONSTITUTES ACCEPTANCE OF THE RATES AND TERMS OF THIS NRA OR NRA AMENDMENT</span></h4></br>";                   

            emailTerms += "<p><font style='font-size:18px;' color='red'>The agreement between International Longshore Association (ILA) and United States Maritime Alliance Ltd (USMX) is expiring on 30th September 2024 with currently no sign of new agreement to be in place by that time.";
            emailTerms += "With no agreement in place, it is foreseen to impact supply chain management leading to delays in Cargo movement, increased costs, logistical challenges for businesses from US East Coast and Gulf Ports. This is also likely to lead to disruption in Import and Export activities, Container availability, Cargo movement, Container movement, and all other allied activities, which may result in extra cost. Unfortunately, all extra cost will be passed on to the cargo owner/booking party being responsible for it. Please make a note of this as this undesirable situation may apply to your current or upcoming bookings.";
            emailTerms += "While we will try to keep you posted on the development, the foregoing is the assessment of the forthcoming situation which may kindly be noted.</font></p>";
            emailTerms += "<p><font style='font-size:18px;' color='red'>You may please monitor current information with the below link:</font></p>";
            emailTerms += "<p><a style='font-size:18px;color:red; text-decoration:none;' href='https://www.usmx.com'>USMX-ILA Negotiations Updates | USMX</a></p></br></br></br>";


            emailTerms += "<div style='text-align:left;'><p style='padding: 20px 0 0 0;'>";
            emailTerms += "<img alt='' src='Images/Icons/mgl_icon_full.png' /></p>";
            emailTerms +="<p style='font-size: 16px; font-weight: bold; color: #009933; line-height: 30px; padding: 0 5px;'><span style='font-size: 13px; color: #000000;'>Air & Ocean NVO/Forwarder, Warehousing & Distribution</span></p>";
        ...
        $scope.approveQuotation = function (source, fromList) {
            ...
            if (entities.length === 0) {
                ...
                ngNotifier.confirm("Are you sure, do you want to Approve/Disapprove for Capturing Shipper's choice?", null, function () {
            ...
            if (fromList) {
                if (action == "copy") {
                    ...
                    if (entities.length == 0 || entities.length > 1) {
                        ...
                        var  msg = 'Are you sure you want to create Quatation?' ;
              

                        ngNotifier.confirm(msg, null, function () {
                            ...
                            entityService.copyQuotaion($scope.entity).then(
                          function (output) {
                              if (output.data.resultId == 2005) {
                                  ngNotifier.showError($scope.authentication, output);
                                  $scope.logOut()
                              }
                              var data = output.data.data;
                              var msg = "Your Enquiry No. is " + data.enquiryNo + " and Quatation No. " + "NRA" + data.quotationNo + " successfully created.";;
                              CopyConfirm(msg);
                          });
                        });
                      return;
            ...
            if (!isCarrierExists) {
                var modalInstance = $uibModal.open({
                    ...
                    controller: function ($scope, $timeout, $uibModalInstance, requestData) {
                        ...
                        $scope.portOriginName = $("#poo").val();
                        $scope.portDischargeName = $("#pod").val();
                        ...
                        $scope.addCarrierCharges = function (action) {
                            if (action == 'update') {
                                ...
                                $scope.enquiryContainers.forEach(function (containerItem) {
                                    ...
                                    $scope.carrierRates.forEach(function (rateItem) {
                                        if (containerItem.containerTypeId == rateItem.fkContainerID && (rateItem.refName == 'Ocean Frieght' || rateItem.refName == 'Ocean Freight')) {
                                ...
                                if (isOceanFrieghtExists == false) {
                                    ngNotifier.error("Please add Ocean Freight charges for all the containers");
                                    return;
                                }
                            }
                            var carrierItem = {};
                            ...
                            if (action == 'update') {
                                ...
                                $scope.carrierRates.forEach(function (item) {
                                    ...
                                    carrierChargeItem.itemremark = item.itemremark;
                        ...
                        $scope.addChargesRow = function () {
                            ...
                            chargesItem.itemremark = $scope.itemremark;
        ...
        $scope.ExportData = function () {
            entityService.ExportQuptationTempData().then(function (data, status, headers, config) {
        ...
        $scope.showQuotationpopup = function () {
            ...
            var modalInstance = $uibModal.open({
                ...
                keyboard: false,
                size: "lg",
                templateUrl: "app/components/operation/quotation/quotationtracking.html",
                controller: "quotationtraModelController",
                resolve: {
                    requestData: function () {
                        return {
                            siteId: $scope.$parent.selectedSiteId
        ...
        var CopyConfirm = function (msg) {
           ...
           // entity.documentCommonID = documentCommonID;
            ...
            var modalInstance = $uibModal.open({
                ...
                keyboard: false,
                size: "lg",
                templateUrl: "app/components/operation/quotation/copyconfirm.html",
                controller: function ($scope, $timeout, $uibModalInstance, requestData) {
                    debugger;
                    $scope.cancel = 1;
                    $scope.msg = msg;
        ...
        $scope.showAllRemarkDetail = function (obj) {
            ...
            entityService.getQuotationRemark(obj.quotationID).then(
                 function (output) {
                     if (output.data.resultId == 2005) {
                         ngNotifier.showError($scope.authentication, output);
                         $scope.logOut()
                     ...
                     $scope.actionRemarksList = output.data.data;
        ...
        $scope.showNextActionRemarksModel = function () {
            ...
            var modalInstance = $uibModal.open({
                ...
                keyboard: false,
                size: "lg",
                templateUrl: "app/components/operation/enquiry/nextActionRemarks.html",
                controller: function ($scope, $timeout, $uibModalInstance, requestData) {
                    $scope.actionRemarks = requestData.actionRemarks
                    $scope.select = function (action) {
                        var outputData = {}
        ...
        $scope.showAllMessage = function (obj) {
            entityService.getQuotationRemark(obj.quotationID).then(
                function (output) {
                    if (output.data.resultId == 2005) {
                        ngNotifier.showError($scope.authentication, output);
                    ...
                    $scope.allMessageList = output.data.data;
                    $scope.showAllMessageModel(obj.quotationID);
        ...
        $scope.showAllMessageModel = function (quotationID) {
            var modalInstance = $uibModal.open({
                animation: false,
                backdrop: "static",
                keyboard: false,
                size: "lg",
                templateUrl: "app/components/operation/quotation/quottracking.html",
                controller: "quotationtraModelController",
                resolve: {
                    requestData: function () {
                        return {
                            actionRemarks: $scope.allMessageList,
        ...
        $scope.closeModelPopup = function (action) {
