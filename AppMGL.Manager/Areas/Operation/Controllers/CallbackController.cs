...
namespace AppMGL.Manager.Areas.Operation.Controllers
{
    public class CallbackController : Controller
    {
            ...
            public async Task<ActionResult> Token()
            {
                ...
                var tokenClient = new TokenClient(QBAPPController.tokenEndpoint, QBAPPController.clientid, QBAPPController.clientsecret);
                ...
                TokenResponse response = await tokenClient.RequestTokenFromCodeAsync(code, QBAPPController.redirectUrl);
                ...
                if (QBAPPController.keys != null)
                {
                    ...
                    if (identityToken != null)
                    {
                        ...
                        if (splitValues[1] != null)
                        {
                            ...
                            {
                                if (payloadData.Aud[0].ToString() != QBAPPController.clientid)
                                {
                                    return false;
                                }
                            }
                            ...
                            {
                                if (payloadData.Iss.ToString() != QBAPPController.issuerEndpoint)
                                {
                        ...
                        rsa.ImportParameters(
                          ...
                          Modulus = Base64Url.Decode(QBAPPController.mod),
                              Exponent = Base64Url.Decode(QBAPPController.expo)
                          });
            ...
            private async Task<IEnumerable<Claim>> GetUserInfoClaimsAsync(string accessToken)
            {
                ...
                var userInfoClient = new UserInfoClient(QBAPPController.userinfoEndpoint);
