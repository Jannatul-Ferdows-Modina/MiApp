...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$location", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "expensesReportService"];
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.reportTable = new NgTableParams(
       {
           ...
           getData: function (params) {
               ...
               return entityService.getExpensesReportList(listParams).then(
                   function (output) {
        ...
        $scope.performBookingSearch = function (source, selectDateOption, fromDate, toDate) {
            ...
            if (selectDateOption != null && selectDateOption != "-Select-") {
            ...
            $scope.searchParam = {
                ...
                fromDate: fromDate,
                toDate: toDate,
                optionValue: $scope.entity.selectOption,
                seachValue: $scope.entity.searchBox,
            };
        ...
        $scope.exportExpensesReport = function (source, selectDateOption, fromDate, toDate) {
            ...
            if ($scope.entity.selectOption == null) {
                optionValue = "-Select-";
            }
            else {
                optionValue = $scope.entity.selectOption;
            }
            if ($scope.entity.searchBox == null) {
                seachValue = " ";
            }
            else {
                seachValue = $scope.entity.searchBox;
            ...
            entityService.exportExpensesReport(reportParams).then(
                function (output) {
    ...
    app.register.controller("expensesReportController", controller);
