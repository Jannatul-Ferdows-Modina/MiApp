...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "enquiryService"];
    ...
    var controller = function ($scope, $filter, $timeout, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        //#region General
        $scope.page = appUrl.enquiry;
        $scope.tabs = appUrl.enquiry.tabs;
            ...
            if ($scope.entityId > 0) {
                entityService.getEnquiryDetail($scope.entity).then(
                     function (output) {
                         ...
                         if ($scope.entity.isapproved_enq == 1)
                         {
                             $scope.entity.isapprovedsel = true;
                         } else {
                             $scope.entity.isapprovedsel = false;
                         }
    ...
    app.register.controller("enquiryController", controller);
