...
define(["app"], function (app) {
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.getDefaultEmailRemarks = function () {
            ...
            emailTerms += "</ul>";
            emailTerms += "<ul><li><h4><span style='font-size: 18px;font-weight: bold;'>THE SHIPPER'S BOOKING OF CARGO AFTER RECEIVING THE TERMS OF THIS NRA OR NRA AMENDMENT CONSTITUTES ACCEPTANCE OF THE RATES AND TERMS OF THIS NRA OR NRA AMENDMENT</span></h4></ul></li>";
