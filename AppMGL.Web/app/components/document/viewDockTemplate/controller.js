...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$timeout", "$uibModal", "$uibModalInstance", "localStorageService", "NgTableParams", "ngNotifier", "authService", "viewDockTemplateService", "requestData"];
    ...
    var controller = function ($scope, $timeout, $uibModal, $uibModalInstance, localStorageService, NgTableParams, ngNotifier, authService, entityService, requestData) {
        ...
        $scope.documentTable = new NgTableParams(
        {
            ...
            getData: function (params) {
                ...
                debugger;
                return entityService.getDockTemplateList(listParams).then(
                    function (output) {
    ...
    app.register.controller("viewDockTemplateController", controller);
