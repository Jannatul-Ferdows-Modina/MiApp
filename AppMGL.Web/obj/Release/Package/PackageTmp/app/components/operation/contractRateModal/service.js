...
define(["app"], function (app) {
    ...
    var service = function ($http, $q, ngAuthSettings, Upload) {
        ...
        var serviceBase = ngAuthSettings.apiServiceBaseUri + "api/contractRateModal/";
        ...
        this.getDocumentAttachmentDetail1 = function (entity) {
            return $http({
                headers: { 'Content-Type': "application/json", 'Pragma': "no-cache", 'Cache-Control': "no-cache" },
                url: serviceBase + "getDocumentAttachmentDetail/",
                method: "POST",
    ...
    app.register.service("contractRateModalService", service);
