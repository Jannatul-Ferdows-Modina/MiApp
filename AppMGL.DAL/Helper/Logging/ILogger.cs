...
namespace AppMGL.DAL.Helper.Logging
{
    ...
    public interface ILogger
    {
        ...
        /// </summary>
        /// <param name="message">The information message to write</param>
        /// <param name="isClient">The exception is generated by the client, or not</param>
        /// <param name="args">The arguments values</param>
        void LogInfo(string message, bool isClient, params object[] args);
        ...
        /// <param name="isClient">The exception is generated by the client, or not</param>
        /// <param name="args">The argument values</param>
        void LogWarning(string message, bool isClient, params object[] args);
        ...
        /// <param name="isClient">The exception is generated by the client, or not</param>
        /// <param name="args">The arguments values</param>
        void LogError(string message, Exception exception, bool isClient, params object[] args);
    }
}
