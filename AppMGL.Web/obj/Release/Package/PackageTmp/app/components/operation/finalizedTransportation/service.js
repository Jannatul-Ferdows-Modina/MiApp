...
define(["app"], function (app) {
    ...
    var service = function ($http, $q, ngAuthSettings, Upload) {
        ...
        this.getFinalizedTransportationList = function (listParams) {
            return $http({
                headers: { 'Content-Type': "application/json", 'Pragma': "no-cache", 'Cache-Control': "no-cache" },
                url: serviceBase + "getFinalizedTransportationList/",
                method: "POST",
                data: listParams
            });
        };

        this.getFinalizedTransportDetails = function (entity) {
            return $http({
                headers: { 'Content-Type': "application/json", 'Pragma': "no-cache", 'Cache-Control': "no-cache" },
                url: serviceBase + "getFinalizedTransportDetails/",
                method: "POST",
                data: entity

            });
        };
        this.saveFinalizedTransport = function (entity) {
            return $http({
                headers: { 'Content-Type': "application/json" },
                url: serviceBase + "saveFinalizedTransport/",
                method: "POST",
                data: entity
    ...
    app.register.service("finalizedTransportationService", service);
