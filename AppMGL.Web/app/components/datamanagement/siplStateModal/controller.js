...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$timeout", "$uibModal", "$uibModalInstance", "localStorageService", "ngNotifier", "authService", "siplStateModalService", "requestData"];
    ...
    app.register.controller("siplStateModalController", controller);
