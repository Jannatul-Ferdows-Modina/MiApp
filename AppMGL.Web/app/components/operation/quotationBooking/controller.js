...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$location", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "quotationBookingService"];
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        //#region General
        $scope.page = appUrl.quotationBooking;
        $scope.tabs = appUrl.quotationBooking.tabs;
        $scope.$parent.pageTitle = "Send for Booking";
        $scope.$parent.breadcrumbs = ["Shipment", "Quotation", "Send for Booking"];
        $scope.carrierList = [];
        ...
        $scope.lookups = { carriers: [], remarks: [] };
        ...
        $scope.filterQuotations = function () {
            ...
            if (dashboardOption != null) {
                if (dashboardOption == 'QSBU') {
                    $scope.dashboardOption = "QSBU";
                }
                
                if (dashboardOption == 'QSBF') {
        ...
        $scope.quotationlistTable = new NgTableParams(
       {
        ...
        var removeBatch = function (enquiryID, quotationID) {
            ...
            ngNotifier.confirm("Are you sure you want to DELETE Quotation?", null, function () {
                var modalInstance = $uibModal.open({
                    ...
                    keyboard: false,
                    size: "lg",
                    templateUrl: "app/components/operation/quotationBooking/cancelRemarks.html",
        ...
        $scope.showEnquiryDetail = function (action, id, isComplete) {
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: "app/components/operation/quotationBooking/enquirydetail.html",
        ...
        $scope.approveQuotation = function (source, fromList) {
            ...
            if (entities.length === 0) {
                ...
                ngNotifier.confirm("Are you sure do you want to Approve Quotation for Booking?", null, function () {
                    ...
                    //$scope.pageTitle = "QuotationBooking";
                    //$scope.breadcrumbs = ["QuotationBooking"];
    ...
    app.register.controller("quotationBookingController", controller);
