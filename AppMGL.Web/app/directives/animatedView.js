...
define(["app"], function (app) {
    ...
    var injectParams = ["$route", "$anchorScroll", "$compile", "$controller"];

    var directive = function ($route, $anchorScroll, $compile, $controller) {
        return {
            restrict: "ECA",
            terminal: true,
    ...
    app.directive("animatedView", directive);
