...
define(["routeResolver"], function () {
    ...
    app.constant("ngAuthSettings", {
      ...
      // apiServiceBaseUri: "https://lo-expert.miamigloballines.com:443/AppMGL/",
        ...
        apiServiceBaseUri: "http://localhost:52965/",
    ...
    app.config(["$routeProvider", "$locationProvider", "$controllerProvider", "$compileProvider", "$filterProvider", "$provide",
        ...
        function ($routeProvider, $locationProvider, $controllerProvider, $compileProvider, $filterProvider, $provide,
            ...
            $routeProvider
                ...
                .when("/security/userjobrole", route.resolve({ module: "userjobrole" }))
                .when("/security/exporttarget", route.resolve({ module: "exporttarget" }))
                ...
                .when("/setup/qb", { templateUrl: "app/views/qb.html" })
               ...
               // .when("/operation/ratecapturequotation", route.resolve({ module: "ratecapturequotation" }))
                ...
                .when("/operation/containerstuffing", route.resolve({ module: "containerstuffing" }))
                .when("/operation/containermanagement", route.resolve({ module: "containermanagement" }))
                .when("/operation/containerbooking", route.resolve({ module: "containerbooking" }))
                .when("/operation/consolidatedockReceipt", route.resolve({ module: "consolidatedockReceipt" }))
                ...
                .when("/operation/documentation1", route.resolve({ module: "documentation1" }))
                ...
                .when("/datamanagement/lgvwhtscode", route.resolve({ module: "lgvwhtscode" }))
                .when("/datamanagement/lgvwlienseexemption", route.resolve({ module: "lgvwlienseexemption" }))
                .when("/datamanagement/lgvwmodeoftransport", route.resolve({ module: "lgvwmodeoftransport" }))
                .when("/datamanagement/lgvwexportinformation", route.resolve({ module: "lgvwexportinformation" }))
                ...
                .when("/datamanagement/freightforwardernetwork", route.resolve({ module: "freightforwardernetwork" }))
               /* .when("/datamanagement/freightforwardermapping", route.resolve({ module: "freightforwardermapping" }))*/
                .when("/datamanagement/ddtcitar", route.resolve({ module: "ddtcitar" }))
                .when("/datamanagement/ddtcusml", route.resolve({ module: "ddtcusml" }))
                ...
                .when("/document/dockReceiptDirect", route.resolve({ module: "dockReceiptDirect" }))
                ...
                .when("/ees/eessub", route.resolve({ module: "eessub" }))
                .when("/ees/aestemplate", route.resolve({ module: "aestemplate" }))
                .when("/operation/sitechange", route.resolve({ module: "sitechange" }))
                .when("/aes", { templateUrl: "app/views/moduleMenu.html" })
                 .when("/crm/accountmanagement", route.resolve({ module: "crmcustomerContact" }))
                 .when("/crm/leadgeneration", route.resolve({ module: "crmenquiry" }))
                 .when("/home/corporate/dashboard", route.resolve({ module: "corporatedashboard" }))
                .when("/operation/bookingCaptureContainerAbandonement", route.resolve({ module: "bookingCaptureContainerAbandonement" }))
                .when("/report/sepatraCommission", route.resolve({ module: "sepataraCommission" }))
                .when("/datamanagement/warehouselocation", route.resolve({ module: "warehouselocation" }))
                .when("/operation/warehousemapping", route.resolve({ module: "warehousemapping" }))
                .when("/home/corporate/mcsReport", route.resolve({ module: "mcsReportCorporate" }))
                  .when("/home/corporate/exportRegisterReport", route.resolve({ module: "exportRegisterReportCorporate" }))
