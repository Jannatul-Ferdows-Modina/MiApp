...
define(["app"], function (app) {
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.addCommodities = function (data) {
            if ($scope.entity.ExportCode == '-' || $scope.entity.ExportCode == '-Select-' || $scope.entity.ExportCode == '' || $scope.entity.ExportCode == undefined) {
                ngNotifier.error("Export Information Code is required");
                return;
            }
            if ($scope.entity.ScheduleB == '') {
                ngNotifier.error("Schedule B or HTS Number is required");
                return;
            }
            if ($scope.entity.FirstQuantity == '') {
                ngNotifier.error("First Quantity is required");
                return;
            }
            if ($scope.entity.FirstUOM == '-Select-' || $scope.entity.FirstUOM == '' || $scope.entity.FirstUOM == undefined) {
                ngNotifier.error("First UOM is required");
                return;
            }
            //if ($scope.entity.SecondQuantity == '') {
            //    ngNotifier.error("Second Quantity is required");
            //    return;
            //}
            if ($scope.entity.SecondUOM == '-Select-' || $scope.entity.SecondUOM == '' || $scope.entity.FirstUOM == undefined) {
                ngNotifier.error("Second UOM is required");
                return;
            }
            if ($scope.entity.OriginofGoods == '-Select-' || $scope.entity.OriginofGoods == '' || $scope.entity.OriginofGoods == undefined)
             {
                ngNotifier.error("Origin of Goods is required");
                return;
            }
            if ($scope.entity.ValueofGoods == '') {
                ngNotifier.error("Value of Goods is required");
                return;
            }
            if ($scope.entity.ShippingWeight == '') {
                ngNotifier.error("Shipping Weight of is required");
                return;
            }
            //if ($scope.entity.Eccn == '') {
            //    ngNotifier.error("Eccn is required");
            //    return;
            //}
            if ($scope.entity.LicenseTypeCode == '-Select-' || $scope.entity.LicenseTypeCode == '' || $scope.entity.LicenseTypeCode == undefined) 
             {
                ngNotifier.error("License Type Code is required");
                return;
                }
            if ($scope.entity.IsGovermentAgency == '' || $scope.entity.LicenseTypeCode == undefined) 
                {
                    ngNotifier.error("Does this filing require Participating Goverment agency data is required");
                    return;
                }
        ...
        $scope.addAesSubmission = function () {
            ...
            if ($scope.entity.isDraft == false) {
                ...
                if ($scope.entity.countryofDestination == undefined || $scope.entity.countryofDestination == "") {
                    ngNotifier.error("Please select Country of Destination.");
                    return;
                }
                if ($scope.entity.inbondType == undefined || $scope.entity.inbondType == "") {
                    ngNotifier.error("Please select Inbond Type.");
                    return;
                }
                ...
                if ($scope.entity.shipmentNumber == "" || $scope.entity.shipmentNumber == undefined) {
                    ngNotifier.error("Shipment Reference Number is required.");
                    return;
                }
                if ($scope.entity.emailResponseAddress == "" || $scope.entity.emailResponseAddress == undefined) {
                    ngNotifier.error("Email Response Address is required.");
                    return;
                }
                if ($scope.entity.emailResponseAddress == "" || $scope.entity.emailResponseAddress == undefined) {
                    ngNotifier.error("Email Response Address is required.");
                ...
                if ($scope.entity.ultimateLastName == "" || $scope.entity.ultimateLastName == undefined) {
                    ngNotifier.error("Ultimate Consignee Last Name is required.");
                    return;
                }
                if ($scope.entity.ultimatePhoneNumber == "" || $scope.entity.ultimatePhoneNumber == undefined) {
                    ngNotifier.error("Ultimate Consignee Phone No is required.");
                    return;
                }
                if ($scope.entity.ultimateAddressLine1 == "" || $scope.entity.ultimateAddressLine1 == undefined) {
                    ngNotifier.error("Ultimate Consignee Address line 1 is required.");
                    return;
                }
                if ($scope.entity.ultimateAddressLine2 == "" || $scope.entity.ultimateAddressLine2 == undefined) {
                    ngNotifier.error("Ultimate Consignee ConsigneePPI Address line 2 is required.");
                    return;
                }
                if ($scope.entity.ultimateCountryId == "" || $scope.entity.ultimateCountryId == undefined) {
                    ngNotifier.error("Ultimate Consignee Country is required.");
                    return;
                }
                if ($scope.entity.ultimatePostalCodeId == "" || $scope.entity.ultimatePostalCodeId == undefined) {
                    ngNotifier.error("Ultimate Consignee Postal Code is required.");
                    return;
                }
                if ($scope.entity.ultimateCity == "" || $scope.entity.ultimateCity == undefined) {
                    ngNotifier.error("Ultimate Consignee City is required.");
                    return;
                }
                if ($scope.entity.ultimateStateId == "" || $scope.entity.ultimateStateId == undefined) {
                    ngNotifier.error("Ultimate Consignee State is required.");
                    return;
                }
                ...
                if ($scope.entity.interIdNumberTypeId == "Please Select" || $scope.entity.interIdNumberTypeId == undefined) {
                    ngNotifier.error("Intermediate Consignee ID Number Type is required.");
                    return;
                }
                if ($scope.entity.interIdNumber == "" || $scope.entity.interIdNumber == undefined) {
                    ngNotifier.error("Intermediate Consignee ID Number is required.");
                    return;
                }
                if ($scope.entity.interCompanyName == "" || $scope.entity.interCompanyName == undefined) {
                    ngNotifier.error("Intermediate Consignee Company Name is required.");
                    return;
                }
                if ($scope.entity.interFirstName == "" || $scope.entity.interFirstName == undefined) {
                    ngNotifier.error("Intermediate Consignee First Name is required.");
                    return;
                }
                if ($scope.entity.interLastName == "" || $scope.entity.interLastName == undefined) {
                    ngNotifier.error("Intermediate Consignee Last Name is required.");
                    return;
                }
                if ($scope.entity.interPhoneNumber == "" || $scope.entity.interPhoneNumber == undefined) {
                    ngNotifier.error("Intermediate Consignee Phone No is required.");
                    return;
                }
                if ($scope.entity.interAddressLine1 == "" || $scope.entity.interAddressLine1 == undefined) {
                    ngNotifier.error("Intermediate Consignee Address line 1 is required.");
                    return;
                }
                if ($scope.entity.interAddressLine2 == "" || $scope.entity.interAddressLine2 == undefined) {
                    ngNotifier.error("Intermediate Consignee Address line 2 is required.");
                    return;
                }
                if ($scope.entity.interCountryId == "" || $scope.entity.interCountryId == undefined) {
                    ngNotifier.error("Intermediate Consignee Country is required.");
                    return;
                }
                if ($scope.entity.interPostalCodeId == "" || $scope.entity.interPostalCodeId == undefined) {
                    ngNotifier.error("Intermediate Consignee Postal Code is required.");
                    return;
                }
                if ($scope.entity.interCity == "" || $scope.entity.interCity == undefined) {
                    ngNotifier.error("Intermediate Consignee City is required.");
                    return;
                }
                if ($scope.entity.interStateId == "" || $scope.entity.interStateId == undefined) {
                    ngNotifier.error("Intermediate Consignee State is required.");
                    return;
                }
                ...
                if ($scope.entity.freightIdNumberTypeId == "Please Select" || $scope.entity.freightIdNumberTypeId == undefined) {
                    ngNotifier.error("Freight Forwarder ID Number Type is required.");
                    return;
                }
                if ($scope.entity.freightIdNumber == "" || $scope.entity.freightIdNumber == undefined) {
                    ngNotifier.error("Freight Forwarder ID Number is required.");
                    return;
                }
                if ($scope.entity.freightCompanyName == "" || $scope.entity.freightCompanyName == undefined) {
                    ngNotifier.error("Freight Forwarder Company Name is required.");
                    return;
                }
                if ($scope.entity.freightFirstName == "" || $scope.entity.freightFirstName == undefined) {
                    ngNotifier.error("Freight Forwarder First Name is required.");
                    return;
                }
                if ($scope.entity.freightLastName == "" || $scope.entity.freightLastName == undefined) {
                    ngNotifier.error("Freight Forwarder Last Name is required.");
                    return;
                }
                if ($scope.entity.freightPhoneNumber == "" || $scope.entity.freightPhoneNumber == undefined) {
                    ngNotifier.error("Freight Forwarder Phone No is required.");
                    return;
                }
                if ($scope.entity.freightAddressLine1 == "" || $scope.entity.freightAddressLine1 == undefined) {
                    ngNotifier.error("Freight Forwarder Address line 1 is required.");
                    return;
                }
                if ($scope.entity.freightAddressLine2 == "" || $scope.entity.freightAddressLine2 == undefined) {
                    ngNotifier.error("Freight Forwarder Address line 2 is required.");
                    return;
                }

                if ($scope.entity.freightPostalCodeId == "" || $scope.entity.freightPostalCodeId == undefined) {
                    ngNotifier.error("Freight Forwarder Postal Code is required.");
                    return;
                }
                if ($scope.entity.freightCity == "" || $scope.entity.freightCity == undefined) {
                    ngNotifier.error("Freight Forwarder City is required.");
                    return;
                }
                if ($scope.entity.freightStateId == "" || $scope.entity.freightStateId == undefined) {
                    ngNotifier.error("Freight Forwarder state is required.");
                    return;
                }
                if ($scope.entity.conveyanceName == "" || $scope.entity.conveyanceName == undefined) {
                    ngNotifier.error("Freight Forwarder email is required.");
                    return;
                }
                // Transportation
                if ($scope.entity.carrierSCAC == "" || $scope.entity.carrierSCAC == undefined) {
                    ngNotifier.error("Carrier SCAC/IATA is required.");
                    return;
                }
                if ($scope.entity.carrierSCAC == "" || $scope.entity.carrierSCAC == undefined) {
                    ngNotifier.error("Conveyance Name/Carrier Name is required.");
                    return;
                }
                if ($scope.entity.transportationReferenceNumber == "" || $scope.entity.transportationReferenceNumber == undefined) {
                    ngNotifier.error("Transportation Reference Number Name is required.");
                    return;
                }
            }
        ...
        $scope.setLookups = function (source, lookup, output, index) {
            ...
            if (lookup == "SIPLContact1") {
                ...
                $scope.entity.ultimatePhoneNumber = output.data[0].telNo;
            ...
            if (lookup == "SIPLContact2") {
              ...
              //  $scope.entity.interLastName = output.data[0].lastName;
                $scope.entity.interPhoneNumber = output.data[0].telNo;
