    ...
    var notifier = function ($log, $window, $location, ngAuthSettings) {
        ...
        return {
            ...
            confirm: function (message, header, okCallback, cancelCallback) {
                ...
                message = "<div><p>" + message + "</p><div><button type=\"button\" class=\"btn btn-primary\" id=\"btnOkn\">OK</button><button type=\"button\" class=\"btn btn-default\" id=\"btnCanceln\">Cancel</button></div></div>";
                toastr.options.timeOut = 0;
                toastr.warning(message, header)
                    .on("click", "#btnOkn", okCallback)
                    .on("click", "#btnCanceln", cancelCallback);
