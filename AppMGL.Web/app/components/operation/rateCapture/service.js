...
define(["app"], function (app) {
    ...
    this.getCarrierContracts = function (id) {
        ...
        this.getRateCapturebreakupDetails = function (type, ContractRateID) {

            return $http({
                headers: { 'Content-Type': "application/json", 'Pragma': "no-cache", 'Cache-Control': "no-cache", "typ": "" + type + "", "ContractRateID":""+ ContractRateID +"" },
                url: serviceBase + "getRateCapturebreakupDetails/",
                method: "GET"              
            });
