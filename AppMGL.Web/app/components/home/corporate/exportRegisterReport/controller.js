...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$location", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "exportRegisterReportCorporateService"];
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.breadcrumbs = ["Corporate", "Export Register"];
        ...
        $scope.lookups = { siplDepartments: [], miamiBookingStatus: [], sites:[] };
        $scope.searchResult = [];
        ...
        $scope.exportRegisterReport = function (source, selectDateOption, fromDate, toDate, galBookingStatusID, departmentID, searchOption1, searchBox1, searchOption2, searchBox2, searchOption3, searchBox3, isCurrentYear, isExcludeCancellRollover) {
            ...
            if ($scope.entity.selectOption1 == null || $scope.entity.selectOption1==undefined) {
                $scope.entity.selectOption1 = "-Select-";
            }
            if ($scope.entity.selectOption2 == null || $scope.entity.selectOption2 == undefined) {
                $scope.entity.selectOption2 = "-Select-";
            }
            if ($scope.entity.selectOption3 == null || $scope.entity.selectOption3==undefined) {
                $scope.entity.selectOption3 = "-Select-";
            }
            ...
            var reportParams = {
                ...
                isCurrentYear: isCurrentYear,
                isExcludeCancellRollover: isExcludeCancellRollover,
                SitId: $scope.entity.siteId.toString() //$scope.$parent.selectedSiteId
            };
    ...
    app.register.controller("exportRegisterReportCorporateController", controller);
