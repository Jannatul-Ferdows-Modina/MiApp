...
define(["app"], function (app) {
    ...
    var injectParams = ["$scope", "$filter", "$timeout", "$routeParams", "$uibModal", "localStorageService", "NgTableParams", "ngNotifier", "lgvwlienseexemptionService"];
    ...
    var controller = function ($scope, $filter, $timeout, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.page = appUrl.lgvwlienseexemption;
        $scope.tabs = appUrl.lgvwlienseexemption.tabs;
    ...
    app.register.controller("lgvwlienseexemptionController", controller);
