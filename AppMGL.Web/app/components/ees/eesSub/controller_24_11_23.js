...
define(["app"], function (app) {
    ...
    var controller = function ($scope, $filter, $timeout, $location, $routeParams, $uibModal, localStorageService, NgTableParams, ngNotifier, entityService) {
        ...
        $scope.addCommodities = function (data) {
            ...
            $scope.entity.commodityDetail[index].ctype = ctype;
            $scope.BlankCommoditesControl();
        ...
        $scope.delCommodities = function (rownum) {
            ...
            if (cind.isType == "O") {
                $scope.entity.commodityDetail[rownum].isType = "X";
                $scope.entity.commodityDetail[rownum].ctype = "X";
            }
            else {
        ...
        $scope.afterFetchLookupData = function (lookupKey) {
            ...
            if (lookupKey == "ddtcitar") { $scope.lookups.ddtcitar.unshift({ "id": 0, "name": "-Select-" }); }
            if (lookupKey == "ddtcusml") { $scope.lookups.ddtcusml.unshift({ "id": 0, "name": "-Select-" }); }
